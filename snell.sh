...
wget -c https://dl.nssurge.com/snell/snell-server-v4.0.1-linux-aarch64.zip	# download binary
unzip -o https://dl.nssurge.com/snell/snell-server-v4.0.1-linux-aarch64.zip
